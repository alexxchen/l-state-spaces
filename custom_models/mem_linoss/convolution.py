...
try:
    ...
    from causal_conv1d import causal_conv1d_update as _causal_conv1d_update_cuda

    causal_conv1d_fn = torch.compiler.allow_in_graph(_causal_conv1d_fn)
    causal_conv1d_update_cuda = torch.compiler.allow_in_graph(_causal_conv1d_update_cuda)
except ImportError:
